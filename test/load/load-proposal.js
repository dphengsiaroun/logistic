...
con.connect(function(err) {
	...
	for (let i = 1; i <= 1000; i++) {
		...
		const value = [
			[i, 
				`{"message":"Bonjour, j'aimerais vous faire une offre contactez-moi. Merci.","name":"toto10",
				"email":"toto10@mail.com","proposalAccountId":"10","adId":"107","titleAd":"110000-111-${i}",
				"imageUrl":"img/truck-default.svg","adAccountId":"1","adType":"carrier","userId":"10",
				"login":"toto10","created_t":1514880767}`, 
				10, 107, 1, 'carrier']
		];
