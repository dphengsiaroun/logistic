...
describe('Already exist', function() {
	...
	it('should create another user', function() {
		...
		const formInvalid = element(by.css('form.ng-invalid'));
		expect(formInvalid).toBeDefined();
		...
		const formValid = element(by.css('form.ng-valid'));		
		expect(formValid).toBeDefined();
