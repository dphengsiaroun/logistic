...
app.component('lgFilter', {
	...
	controller: function LgFilterCtrl($element, $scope, $state, $rootScope,
		...
		console.log('LgFilterCtrl', arguments);
		...
		ctrl.isFilterOn = false;

		ctrl.toggle = function() {
			console.log('toggle', arguments);
			console.log('ctrl.lgFilterContentElt', ctrl.lgFilterContentElt);
			console.log('1 ctrl.isFilterOn', ctrl.isFilterOn);
			ctrl.isFilterOn = !ctrl.isFilterOn;
			console.log('2 ctrl.isFilterOn', ctrl.isFilterOn);
			if (ctrl.isFilterOn) {
				ctrl.lgFilterContentElt.css('display', 'block');
				// ctrl.refreshNotifications();
			} else {
				console.log('off', arguments);
				ctrl.isFilterOn = false;
				ctrl.lgFilterContentElt.css('display', 'none');
			}
...
app.component('lgFilterContent', {
	require: {
		lgFilter: '^^lgFilter',
	},
	controller: ['$element', function LgFilterContentCtrl($element) {
		console.log('lgFilterContent ctrl', arguments, this);
		this.$onInit = function() {
			this.lgFilter.lgFilterContentElt = $element;
