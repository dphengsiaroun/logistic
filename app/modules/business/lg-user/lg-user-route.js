...
function initCtrl(ctrl, $scope, $injector) {
	...
	$scope.$watch('$ctrl.user.signupData.content.login', function() {
		...
		ctrl.user.signupData.login = angular.lowercase(ctrl.user.signupData.content.login);
		console.log('ctrl.user.signupData.login', ctrl.user.signupData.login);
	...
	$scope.$watch('$ctrl.user.updateData.content.login', function() {
		...
		ctrl.user.updateData.login = angular.lowercase(ctrl.user.updateData.content.login);
		console.log('ctrl.user.updateData.login', ctrl.user.updateData.login);
